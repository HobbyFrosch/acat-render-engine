...
class ACatPlaceholderTest extends TestCase {
	...
	public function getTextPlaceholder () : void {
		...
		$expectedXmlString = '<acat:text xmlns:acat="https://schemas.acat.akademie.uni-bremen.de" id="' . $textNode->getId() . '" space="preserve">' . $text . '</acat:text>';
	...
	public function getStartBlockPlaceholder() : void {
		...
		$expectedXmlString = '<acat:block xmlns:acat="https://schemas.acat.akademie.uni-bremen.de" id="' . $startBlock->getId() . '" type="start"/>';
	...
	public function getEndBlockPlaceholder() : void {
		...
		$expectedXmlString = '<acat:block xmlns:acat="https://schemas.acat.akademie.uni-bremen.de" id="' . $endBlock->getId() . '" type="end"/>';
