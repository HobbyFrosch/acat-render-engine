 ...
 *
 */
class WordElementGeneratorTest extends AbstractElementTest {
	...
	public function getTextBlock() : void {
		...
		foreach ($textBlocks as $textBlock) {
			...
			$this->assertEquals('d9134945-880b-4f5d-ab1d-74830f028bbf', $textBlock->getChildren()[1]->getElement()->getAttribute('id'));
